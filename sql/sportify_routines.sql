...
/*!50003 DROP PROCEDURE IF EXISTS `p_insert_game_interaction` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
DELIMITER ;;
CREATE DEFINER=`pedro_morais`@`%` PROCEDURE `p_insert_game_interaction`(
	IN score DECIMAL(10,2),
    IN id_user INT,
    IN id_game INT
)
BEGIN
   INSERT INTO run_data VALUES (default, score, id_user, id_game, default);
   INSERT INTO interaction VALUES (default, 'game', id_user, default);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `p_insert_post_interaction` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`pedro_morais`@`%` PROCEDURE `p_insert_post_interaction`(
	IN post_title VARCHAR(50),
    IN post_description VARCHAR(500),
    IN id_user INT
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `p_insert_recipe_interaction` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`pedro_morais`@`%` PROCEDURE `p_insert_recipe_interaction`(
	IN recipe_title VARCHAR(50),
    in recipe_ingredients VARCHAR(1000),
    IN recipe_description VARCHAR(1000),
    IN recipe_prep_method VARCHAR(1000),
    IN id_user INT
)
BEGIN
   INSERT INTO recipes VALUES (default, recipe_title, recipe_ingredients, recipe_description, recipe_prep_method, id_user, default);
   INSERT INTO interaction VALUES (default, 'recipe', id_user, default);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
