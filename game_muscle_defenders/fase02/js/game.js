...
const LASER_MAX_SPEED_ENEMY = 175.0
...
let baseScore = 100
let score = parseFloat(localStorage.getItem("points")) || 0
let minutes = 0
let seconds = 0
let interval
...
function createPlayer(container) {
  ...
  //const player_character = document.createElement("img")
  player_character.src = "../assets/images/estagio_2.png"
...
function updatePlayer(dt, container) {
  ...
  if (GAME_STATE.spacePressed && GAME_STATE.playerCooldown <= 0) {
    ...
    player_character.src = "../assets/images/estagio_2_acao.png"
    player_character.className = "player"
  }
  if(!GAME_STATE.spacePressed && GAME_STATE.playerCooldown <= 0){
    player_character.src = "../assets/images/estagio_2.png"
